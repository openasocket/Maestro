 ...
 *
 * A React error boundary for wrapping individual widgets/charts. Catches
 * JavaScript errors in its children and displays a retry UI so a single widget
 * failure never blanks the surrounding surface.
 *
 * Features:
 * - Theme-aware styling matching the surrounding surface
