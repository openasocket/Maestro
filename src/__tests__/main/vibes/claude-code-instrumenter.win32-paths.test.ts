/**
 * Windows path-shape tests for the Claude Code instrumenter's normalizePath()
...
} from '../../../main/vibes/instrumenters/claude-code-instrumenter';

describe('claude-code-instrumenter normalizePath (win32)', () => {
