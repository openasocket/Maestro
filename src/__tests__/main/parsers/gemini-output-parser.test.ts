...
describe('GeminiOutputParser', () => {
	...
	describe('isResultMessage', () => {
		it('should return true for result events', () => {
			const event = parser.parseJsonLine(JSON.stringify({ type: 'result', status: 'success' }));
		...
		it('should return false for non-result events', () => {
			const initEvent = parser.parseJsonLine(JSON.stringify({ type: 'init', session_id: 'test' }));
	...
	describe('extractSessionId', () => {
		it('should extract session ID from init event', () => {
			const event = parser.parseJsonLine(JSON.stringify({ type: 'init', session_id: 'gem-abc' }));
	...
	describe('extractUsage', () => {
		...
		it('should return null for events without usage', () => {
			const event = parser.parseJsonLine(JSON.stringify({ type: 'init', session_id: 'test' }));
