...
const mockMaestro = {
	...
	grpo: {
		getConfig: vi.fn().mockResolvedValue({ success: true, data: { enabled: false } }),
		setConfig: vi.fn().mockResolvedValue({ success: true }),
		getLibrary: vi.fn().mockResolvedValue({ success: true, data: [] }),
		addExperience: vi.fn().mockResolvedValue({ success: true, data: { id: 'exp-new' } }),
		modifyExperience: vi.fn().mockResolvedValue({ success: true }),
		deleteExperience: vi.fn().mockResolvedValue({ success: true }),
		getHistory: vi.fn().mockResolvedValue({ success: true, data: [] }),
		collectRewards: vi.fn().mockResolvedValue({ success: true, data: [] }),
		...
		getModelStatus: vi.fn().mockResolvedValue({ success: true, data: 'not-available' }),
