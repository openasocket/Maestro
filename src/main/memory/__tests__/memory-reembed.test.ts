...
vi.mock('../../../main/grpo/embedding-service', async () => {
	const actual = await vi.importActual<typeof import('../../../main/grpo/embedding-service')>(
		'../../../main/grpo/embedding-service'
	);
	return {
		...
		isReady: () => true,
		VECTOR_DIM: actual.VECTOR_DIM,
		EmbeddingModelNotAvailableError: actual.EmbeddingModelNotAvailableError,
	};
});
