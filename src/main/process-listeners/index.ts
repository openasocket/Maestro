...
import { setupGRPOListener } from './grpo-listener';
...
export function setupProcessListeners(
	...
	// GRPO signal collection listener (passive reward signals from agent exits)
	setupGRPOListener(processManager, deps);
}
